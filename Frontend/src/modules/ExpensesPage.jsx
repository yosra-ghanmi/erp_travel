  ...
  return (
    <div className="grid gap-6 xl:grid-cols-3">
      <div className="xl:col-span-2">
        <Panel title="Expenses Tracker" right={<p className="text-xs text-slate-500">{expenses.length} records</p>}>
          ...
          <DataTable
            ...
            rows={expenses.map((exp) => (
              <tr key={exp.expenseid} className="border-b border-slate-100 dark:border-slate-800">
                ...
                <td className="px-2 py-3 font-bold text-rose-600">-${exp.amount}</td>
