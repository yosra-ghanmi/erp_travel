import { BrainCircuit, Building2, ClipboardList, LayoutDashboard, ReceiptText, Settings, UserPlus2, Users, Wrench, Wallet, CreditCard, ShoppingCart } from 'lucide-react'

export const modulesByRole = {
  super_admin: [
    { key: 'platform_overview', label: 'Platform Overview', icon: LayoutDashboard },
  ...
  agency_admin: [
    { key: 'agency_dashboard', label: 'Agency Dashboard', icon: LayoutDashboard },
    { key: 'staff_management', label: 'Staff Management', icon: UserPlus2 },
    { key: 'services', label: 'Services', icon: Wrench },
    { key: 'clients', label: 'Clients', icon: Users },
    { key: 'bookings', label: 'Bookings', icon: ReceiptText },
    { key: 'travel_offers', label: 'Travel Offers', icon: ClipboardList },
